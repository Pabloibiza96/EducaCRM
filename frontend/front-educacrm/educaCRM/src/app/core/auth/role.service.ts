...
export type Permission =
  ...
  | 'view_departamentos' | 'create_departamentos' | 'edit_departamentos' | 'delete_departamentos'
  | 'view_dashboard'
  | 'view_reports';
...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  // Dirección: gestión global, pero sin tocar usuarios ni departamentos a bajo nivel
  direccion: [
    'view_alumnos',
    'view_profesores',
    'view_asignaturas',
...
export class RoleService {
  ...
  isDireccion(): boolean  { return this.hasRole('direccion'); }
  isJefatura(): boolean   { return this.hasRole('jefatura'); }
  isProfesor(): boolean   { return this.hasRole('profesor'); }
  ...
  canAccessModule(
    module: 'alumnos' | 'profesores' | 'asignaturas' | 'grupos' | 'calificaciones' | 'usuarios' | 'departamentos',
  ): boolean {
